...
var (
	...
	ErrDriftExceeded   = errors.New("cooltower: drift exceeded")
	ErrFillBlock       = errors.New("cooltower: fill block active")
	ErrAntifreezeHold  = errors.New("cooltower: antifreeze hold")
